        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: 16) {
                SettingsCard(
                    ...
                    SettingsSectionBox {
                        VStack(alignment: .leading, spacing: 8) {
                            Text("Hier findest du verständliche Erklärungen zur Bedienung, den Berechnungen sowie den Regeln für den Abschluss.")
                                .font(helperFont)
                ...
                SettingsCard(
                    ...
                    SettingsSectionBox {
                        VStack(alignment: .leading, spacing: 12) {
                            Text("Gesamtdurchschnitt in Übersicht & Insights")
                                .font(.headline)
                            infoRow(
                                title: "Grundlage",
                ...
                SettingsSectionBox {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        infoRow(
                            ...
                            text: "FOS/BOS 12: Es dürfen höchstens zwei Prüfungen unter 4 Punkten sein. Wenn eine Prüfung 0 Punkte hat, wird sie doppelt als „schwach“ gezählt. FOS/BOS 13: Keine Prüfung darf 0 Punkte haben; höchstens zwei dürfen bei 1–3 Punkten liegen."
                        )
                        infoRow(
                            title: "In der App",
                ...
                SettingsSectionBox {
                    VStack(alignment: .leading, spacing: 12) {
                        Text("Abschlussnote nach BayFOBOSO")
                            .font(.headline)
                        infoRow(
                            title: "Was einfließt",
